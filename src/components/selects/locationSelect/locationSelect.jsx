...
import selfClasses from './locationSelect.module.scss';

import { useRef, useState, useEffect } from 'react';
import { setLocation } from '../../redux/filtersSlice';

const LocationSelect = ({ name, values }) => {
  ...
  return (
    <div
      ...
      <div
        ...
        <div className={classes.selected__nameWrapper}>
          <span>{name}</span>
        </div>
        ...
        <div className={classes.selected__controls}>
          <svg
            ...
            onClick={() => dispatch(setLocation({ id: 0, location: 'Location' }))}
            width="9"
            height="9"
            viewBox="0 0 9 9"
            fill="none"
      ...
      <div
        className={
          isSelectActive
            ? `${classes.options} ${classes.options_active} ${selfClasses.options}`
            : classes.options
        }>
