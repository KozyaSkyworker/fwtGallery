    ...
    <header className="header">
      <div className="container">
        <div className="header__inner">
          ...
          <button
            className={
              isLight ? 'header__theme-swither' : 'header__theme-swither header__theme-swither_dark'
            }
            onClick={() => dispatch(setTheme(!isLight))}>
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
